        ...
        <div class="mt-8 flow-root">
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tr>
                        @include('components.table-header', [ 'name' => 'name', 'displayName' => 'Name'])
                        @include('components.table-header', [ 'name' => 'mykad_ssm', 'displayName' => 'MyKad/SSM'])
                        @include('components.table-header', [ 'name' => 'category', 'displayName' => 'Category'])
                        @include('components.table-header', [ 'name' => 'status', 'displayName' => 'Status'])
                    ...
                    @foreach ($clients as $client)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                                <span class="{{ $this->getStatusClass($client->status) }}">
                                    {{ $client->status }}
                                </span>
                            </td>
                            <td class="relative whitespace-nowrap py-4 pl-3 text-right text-sm font-medium sm:pr-6">
                                <button class="text-indigo-600 hover:text-indigo-900" x-on:click="edit = ! edit; selectedClientId = '{{ $client->id }}'" form="edit-form">
                            ...
                            <td class="relative whitespace-nowrap py-4 pl-3 text-left text-sm font-medium sm:pl-0 sm:pr-6">
                                <button x-on:click="deleteModal = true; selectedClientId='{{ $client->id }}'; selectedClientName='{{ $client->name }}'" class="text-red-600 hover:text-red-900">
                                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <div class="flex space-x-4 items-center mb-3 mt-3">
