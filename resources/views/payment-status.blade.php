...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-100" x-data="{ statusId: {{ $statusId }} }">
            <!-- Success Message -->
            <div class="bg-white p-6 md:mx-auto" x-cloak x-show="statusId == 1">
                ...
                <div class="text-center">
                    ...
                    <div class="py-10 text-center">
                        <a href="/dashboard" class="px-12 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3">
                            Dashboard
                        </a>
                    </div>
                </div>
            ...
            <!-- Failure Message -->
            <div class="bg-white p-6 md:mx-auto" x-cloak x-show="statusId == 2 || statusId == 3">
